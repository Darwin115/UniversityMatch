...
<body onload="iniciarLectura()">
  ...
  <script>
    ...
    var textoUniversidad = "El campus Aguascalientes es una de las tres sedes que tiene la Universidad Panamericana en la República Mexicana. Esta sede tiene una oferta académica de 10 licenciaturas y 7 ingenierías; además, cuenta con 13 especialidades y 16 maestrías. Contando todos los campus, la UP tiene alrededor de 12,000 alumnos. Entre los reconocimientos que sus estudiantes han recibido se encuentran: Premio a la originalidad en concurso TUAPP en 2017. Reconocimiento como una de las 50 empresas más innovadoras de la Revista Information Week en 2015. Participación en la Feria de la UNIDO de la ONU para el establecimiento de alianzas laborales y de desarrollo con estas importantes instituciones internacionales.";
