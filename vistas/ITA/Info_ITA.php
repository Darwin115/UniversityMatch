...
<body onload="iniciarLectura()">
  ...
  <script>
    ...
    var textoUniversidad = "La MISIÓN del Instituto Tecnológico de Aguascalientes es ofrecer educación superior tecnológica de calidad, para formar profesionistas que sean agentes de cambio, con la capacidad de generar conocimiento e innovación en su campo profesional, desempeñarse de manera ética, moral, incluyente y comprometida con el desarrollo sustentable y sostenible, e insertarse con éxito en la comunidad global. La VISIÓN del Instituto Tecnológico de Aguascalientes es Ser una Institución de Educación Superior Tecnológica reconocida internacionalmente por su Calidad Académica al generar conocimiento para el desarrollo sostenible y equitativo, de la humanidad.";
