...
<body onload="iniciarLectura()">
  ...
  <section id="inPlan">
    ...
    <section id="inPlanImg">
        <div class="infoPlan">
            <a href="../../CarrerasUNID/ITICS.php"><img src="../../img/uniPics/UNID/Carreras/ITICS.png" alt></a>
        </div>
        <div class="infoPlan">
          <a href="../../CarrerasUNID/IG.php"><img src="../../img/uniPics/UNID/Carreras/IG.png" alt></a>
        </div>
        <div class="infoPlan">
            <a href="../../CarrerasUNID/IQ.php"><img src="../../img/uniPics/UNID/Carreras/IQ.png" alt></a>
        </div>
    </section>
    <section id="inPlanImg">
      <div class="infoPlan">
          <a href="../../CarrerasUNID/IELECTRI.php"><img src="../../img/uniPics/UNID/Carreras/IELECTRI.png" alt></a>
      </div>
      <div class="infoPlan">
        <a href="../../CarrerasUNID/IELECTRO.php"><img src="../../img/uniPics/UNID/Carreras/IELECTRO.png" alt></a>
      </div>
      <div class="infoPlan">
          <a href="../../CarrerasUNID/II.php"><img src="../../img/uniPics/UNID/Carreras/II.png" alt></a>
      </div>
    </section>
    <section id="inPlanImg">
      <div class="infoPlan">
          <a href="../../CarrerasUNID/IMATE.php"><img src="../../img/uniPics/UNID/Carreras/IMATE.png" alt></a>
      </div>
      <div class="infoPlan">
        <a href="../../CarrerasUNID/IMECA.php"><img src="../../img/uniPics/UNID/Carreras/IMECA.png" alt></a>
      </div>
      <div class="infoPlan">
          <a href="../../CarrerasUNID/IS.php"><img src="../../img/uniPics/UNID/Carreras/IS.png" alt></a>
      </div>
    </section>
    <section id="inPlanImg">
      <div class="infoPlan">
          <a href="../../CarrerasUNID/LA.php"><img src="../../img/uniPics/UNID/Carreras/LA.png" alt></a>
      </div>
    </section>
  </section>
