  ...
  <div class="container">
    ...
    <div class="filters-container1">
      ...
      <select id="categoria">
        ...
        <option value="tec">Tecnología e Ingeniería</option>
        <option value="salud">Ciencias de la Salud</option>
        <option value="edu">Educación y Pedagogía</option>
        <option value="eco">Economía y Negocios</option>
        <option value="idiomas">Idiomas</option>
      </select>

      <select id="nivel">
        <option value="ninguno">Filtrar por nivel</option>
