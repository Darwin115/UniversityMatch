    ...
    <div class="container text-center">
        ...
        <h2 class="font-weight-bold">Detalles de tu solicitud de donación</h2>
            <div class="product-image mb-4">
                <img src="confirmacion/Equipo.webp" alt="Equipo Pc Dell Optiflex" class="img-fluid" style="max-width: 50%; height: auto; border-radius: 10px;">
            </div>

            <div class="order-summary mb-4">
                <p><strong>Nombre del producto:</strong> Equipo Pc Dell Optiflex</p>
                <p><strong>Precio:</strong> 0.00 MXN</p>
                <p><strong>Costo de envío:</strong> 99.00 MXN</p>
                <p><strong>Descripción:</strong> Equipo PC Dell de 22.1'' pulgadas y un almacenamiento de 16GB RAM SSD 256GB Con procesador Core i5 8th Generación + Teclado DELL, Mouse DELL, Monitor DELL, Base DELL, CPU DELL, Auriculares, USB inalambrico.</p>
            </div>
