    ...
    <div class="container text-center">
        ...
        <h2 class="font-weight-bold">Detalles de tu solicitud de donación</h2>
            <div class="product-image mb-4">
                <img src="confirmacion/Dell_.jpg" alt="DELL Latitude 5410" class="img-fluid" style="max-width: 50%; height: auto; border-radius: 10px;">
            </div>

            <div class="order-summary mb-4">
                <p><strong>Nombre del producto:</strong> DELL Latitude 5410</p>
                <p><strong>Precio:</strong> 0.00 MXN</p>
                <p><strong>Costo de envío:</strong> 99.00 MXN</p>
                <p><strong>Descripción:</strong> Business Laptop, Intel Core i5-10310U Quad Core 4.4GHz, FHD de 14 Pulgadas, 16GB RAM, 512GB SSD, CAM, Windows 10 Pro</p>
            </div>
