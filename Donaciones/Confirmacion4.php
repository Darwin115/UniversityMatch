    ...
    <div class="container text-center">
        ...
        <h2 class="font-weight-bold">Detalles de tu solicitud de donación</h2>
            <div class="product-image mb-4">
                <img src="confirmacion/Escritorio.jpg" alt="Escritorio de madera" class="img-fluid" style="max-width: 50%; height: auto; border-radius: 10px;">
            </div>

            <div class="order-summary mb-4">
                <p><strong>Nombre del producto:</strong> Escritorio de madera</p>
                <p><strong>Precio:</strong> 0.00 MXN</p>
                <p><strong>Costo de envío:</strong> 99.00 MXN</p>
                <p><strong>Descripción:</strong> Escritorio para Computadora Minimalista con Gabinete y 3 Cajones De Almacenamiento Retro Industrial Desk con Librero para Oficina, Dormitorio, Gamer, Café, Desayuno, Dibujo,Home (140x60x74.2CM)</p>
            </div>
