...
<?php include '../header.php'; ?>
  ...
  <script>
    ...
    var textoUniversidad = "En la presente sección, podrás realizar tu test vocacional y descubrir en qué ámbito se encuentra la carrera ideal para tí. Cuando gustes podemos comenzar.";
